...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-global-4 text-button-1 hover:opacity-90 active:opacity-80 focus:ring-global-3',
  ...
  return (
    <button
      ...
      className={`
        ...
        touch-manipulation
        font-poppins
        border-[1px] border-solid border-image-[linear-gradient(180deg,#8b8681_0%,_#d2cdc6_100%)]
        ${className}
      `.trim().replace(/\s+/g, ' ')}
